...
Dataset: Karawatha Peri-Urban Vegetation Hollow Data (2009)

Task: Predict tree species from environmental and tree features.
...
Task: Predict whether an appliance has a star rating above 3.
...
Make sure all CSVs are in the data/ folder (already included).
